...
<div class="frm_grid_container">
	...
	<p class="frm4 frm_form_field">
		<label for="single_entry">
			...
			<?php printf( __( 'Limit number of entries %1$sto one per%2$s', 'formidable-pro' ), '<span class="frm-single-entry-setting' . esc_attr( $values['single_entry'] ? '' : ' frm_invisible' ) . '">', '</span>' ); ?>
		</label>
	</p>
	<p class="frm8 frm_form_field frm_select_with_label">
